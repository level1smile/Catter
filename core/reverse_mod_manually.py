...
from .common.buffer_file import IndexBufferBufFile,FmtFile
from .common.global_config import GlobalConfig
from .utils.dbmt_log_utils import log_newline
...
if __name__ == "__main__":
    ...
    for gametypename in matched_gametypename_list:
        ...
        for ib_file_path in index_buffer_filepath_list:
            ...
            # You may wonder why i use complete vb file? this will take more disk space and import extra vertices, 
            # why i don't split it just like my other reverse tool?
            # Because it's for ShapeKey reverse technique for SinsOfSeven's SliderImpact
            # First you reverse Base, then you reverse a shapekey, then it will need vertex count match
            # so you can play "Join As ShapeKey" to reverse the Shapekey back to Base model.
            # split will break vertex count equal condition.
